...
* See also: [The PDF Association's list of PDF-focused corpora](https://github.com/pdf-association/pdf-corpora) ⭐ 184 | 🐛 0 | 📅 2026-08-30
* [veraPDF Corpus](https://github.com/veraPDF/veraPDF-corpus) ⭐ 92 | 🐛 10 | 📅 2026-09-01 - For PDF/A.
...
* [Contribute a file format signature to FILE](https://github.com/glensc/file) ⭐ 1,655 | 🐛 1 | 🌐 C | 📅 2026-08-28 - See [this guide](http://www.openpreservation.org/blogs/2012-08-09-magic-editing-and-creation-primer).
